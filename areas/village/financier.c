...
"elegance. Dark wood paneling and shelves of ledgers convey reliability, while "
"a large oak desk centers the room, ready for business. Here, in an atmosphere "
"of calm efficiency, the financier oversees the village's wealth, offering "
"counsel and loans with a steady hand. This space is the heart of financial "
"dealings, where futures are shaped with care and precision.") ;
    set_items(([
    ...
    ({ "dark wood paneling", "wood paneling", "paneling" }) :
        ...
        "story of meticulous care and traditional values, grounding the office "
        "in a sense of enduring reliability.",
    ({ "leather-bound ledgers", "ledgers" }) :
        ...
        "and supple, holds the weight of countless transactions, embodying the "
        "history and diligence of the financier's practice.",
    ({ "oak desk", "desk" }) :
