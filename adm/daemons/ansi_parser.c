...
varargs string parse_pinkfish(string msg, int flag)
{
    ...
    if(pcre_match(msg, XTERM256_COLOURS))
    {
        if(flag) msg = XTERM256->substitute_colour(msg, "plain") ;
        else msg = XTERM256->substitute_colour(msg, "xterm") ;
    }
