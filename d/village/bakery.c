...
void setup() {
    ...
    set_long("The cozy bakery, marked by a cheerful wooden sign shaped like a "
    ...
    set_items(([
        ({ "wooden sign", "sign", "bread-shaped sign" }) :
            ...
            "Bakery' are painted in warm, inviting colors, beckoning passersby "
            "with the promise of fresh baked goods.",
        ({ "glass display case", "display case", "case" }) :
            ...
            "breads, flaky pastries, and colorful cakes are artfully arranged, "
            "each item looking more delicious than the last.",
        ...
        ({ "wooden worktable", "worktable", "table" }) :
            "A sturdy wooden worktable stands in the center of the bakery, its "
            "surface dusted with flour and bearing the marks of years of use. "
            "This is where the magic happens, as the baker transforms simple "
            "ingredients into delicious breads and pastries.",
        ({ "baked goods", "goods", "breads", "pastries" }) :
            "An enticing array of baked goods fills the bakery. Golden loaves "
            "of various shapes and sizes, some studded with nuts or dried fruits, "
            "sit alongside delicate pastries glistening with sugar or filled "
            "with colorful jams. The variety is impressive, catering to every "
            "taste and occasion.",
        "air" :
